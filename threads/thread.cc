...
Thread::Thread(char* threadName) {
    ...
    space = NULL;
    openFiles = new map<int, std::string>;
...
void Thread::closeOpenFileById(int fileId) {
    kernel->semReads->at(fileId)->P();
    kernel->semWrites->at(fileId)->P();
    openFiles->erase(fileId);
    kernel->semWrites->at(fileId)->V();
    kernel->semReads->at(fileId)->V();
}